...
#if defined AMD_GCN
                         __global volatile double *inter,   //the buffer used for adjacent synchronization
#else
   ...
   unsigned int gid = get_group_id(0);
    ...
    if(lid==0){   //adjacent synchronization
#if defined BLOCK_HEIGHT_1
        if(gid ==0||t1!=0){
            atom_xchg((volatile __global ulong *)(inter+gid),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P])));
        }
        if(gid != 0){
            while((ft1=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+gid-1),(ulong)(as_ulong(DBL_MAX))))))==DBL_MAX){}
        }
        else
            ft1=0.0;
        if(gid!=0 && t1==0){
            atom_xchg( (volatile __global ulong *)(inter+gid),(ulong)(as_ulong(ft1 + last_partial_sums[NB_LSIZE_1+NB_LSIZE_P])));
        }
...
#if defined BLOCK_HEIGHT_2
        if(gid ==0||t1!=0){
            atom_xchg((volatile __global ulong *)(inter+gid*2),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s0)));
            atom_xchg((volatile __global ulong *)(inter+gid*2+1),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
        }
        if(gid != 0){
            while((ft1.s0=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*2),(ulong)(as_ulong(DBL_MAX))))))==DBL_MAX){}
            ft1.s1=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*2+1),(ulong)(as_ulong(DBL_MAX)))));
        }
        else
            ft1=0.0;
        if(gid!=0 && t1==0){
            atom_xchg((volatile __global ulong *)(inter+gid*2),(ulong)(as_ulong(ft1.s0+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s0)));
            atom_xchg((volatile __global ulong *)(inter+gid*2+1),(ulong)(as_ulong(ft1.s1+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
        }
        previous_workgroups_last_partial_sum = ft1;   
    }
#endif
...
#if defined BLOCK_HEIGHT_3
        if(gid ==0||t1!=0){
            atom_xchg((volatile __global ulong *)(inter+gid*4),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s0)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+1),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+2),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s2)));
        }
        if(gid != 0){
            while((ft1.s0=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4),(ulong)(as_ulong(DBL_MAX))))))==DBL_MAX){}
            ft1.s1=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+1),(ulong)(as_ulong(DBL_MAX)))));
            ft1.s2=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+2),(ulong)(as_ulong(DBL_MAX)))));
        }
        else
            ft1=0.0;
        if(gid!=0 && t1==0){
            atom_xchg((volatile __global ulong *)(inter+gid*4),(ulong)(as_ulong(ft1.s0+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s0)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+1),(ulong)(as_ulong(ft1.s1+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+2),(ulong)(as_ulong(ft1.s2+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s2)));
        }
        previous_workgroups_last_partial_sum = ft1;   
    }
#endif
        ...
        if(gid ==0||t1!=0){
            ...
            atom_xchg((volatile __global ulong *)(inter+gid*4+1),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+2),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s2)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+3),(ulong)(as_ulong(last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s3)));
        }
        if(gid != 0){
            while((ft1.s0=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4),(ulong)(as_ulong(DBL_MAX))))))==DBL_MAX){}
            ft1.s1=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+1),(ulong)(as_ulong(DBL_MAX)))));
            ft1.s2=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+2),(ulong)(as_ulong(DBL_MAX)))));
            ft1.s3=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+3),(ulong)(as_ulong(DBL_MAX)))));
        }
        else
            ft1=0.0;
        if(gid!=0 && t1==0){
            ...
            atom_xchg((volatile __global ulong *)(inter+gid*4+1),(ulong)(as_ulong(ft1.s1+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+2),(ulong)(as_ulong(ft1.s2+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s2)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+3),(ulong)(as_ulong(ft1.s3+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s3)));
        }
        previous_workgroups_last_partial_sum = ft1;   
    }
#endif
