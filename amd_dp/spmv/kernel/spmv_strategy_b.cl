                         ...
                         __global RES_TYPE *res) 
{
   ...
   unsigned int gid = get_group_id(0);
    ...
    if(lid==0){   //adjacent synchronization
        ...
        if(gid != 0){
            while((ft=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+gid-1),(ulong)(as_ulong(DBL_MAX))))))==DBL_MAX){}
        }
        else
            ft=0.0;
        if(gid!=0 && t1==0){
            atom_xchg( (volatile __global ulong *)(inter+gid),(ulong)(as_ulong(ft + last_partial_sums[NB_LSIZE_1+NB_LSIZE_P])));
        }
    }
#endif
        ...
        if(gid != 0){
            while((ft.s0=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*2),(ulong)(as_ulong(DBL_MAX))))))==DBL_MAX){}
            ft.s1=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*2+1),(ulong)(as_ulong(DBL_MAX)))));
        }
        else
            ft=0.0;
        if(gid!=0 && t1==0){
            atom_xchg((volatile __global ulong *)(inter+gid*2),(ulong)(as_ulong(ft.s0+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s0)));
            atom_xchg((volatile __global ulong *)(inter+gid*2+1),(ulong)(as_ulong(ft.s1+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
        }
    }
#endif
        ...
        if(gid != 0){
            while((ft.s0=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4),(ulong)(as_ulong(DBL_MAX))))))==DBL_MAX){}
            ft.s1=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+1),(ulong)(as_ulong(DBL_MAX)))));
            ft.s2=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+2),(ulong)(as_ulong(DBL_MAX)))));
        }
        else
            ft=0.0;
        if(gid!=0 && t1==0){
            atom_xchg((volatile __global ulong *)(inter+gid*4),(ulong)(as_ulong(ft.s0+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s0)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+1),(ulong)(as_ulong(ft.s1+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+2),(ulong)(as_ulong(ft.s2+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s2)));
        }
    }
#endif
        ...
        if(gid != 0){
            ...
            ft.s1=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+1),(ulong)(as_ulong(DBL_MAX)))));
            ft.s2=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+2),(ulong)(as_ulong(DBL_MAX)))));
            ft.s3=(double)(as_double(atom_xchg((volatile __global ulong *)(inter+(gid-1)*4+3),(ulong)(as_ulong(DBL_MAX)))));
        }
        else
            ft=0.0;
        if(gid!=0 && t1==0){
            ...
            atom_xchg((volatile __global ulong *)(inter+gid*4+1),(ulong)(as_ulong(ft.s1+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s1)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+2),(ulong)(as_ulong(ft.s2+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s2)));
            atom_xchg((volatile __global ulong *)(inter+gid*4+3),(ulong)(as_ulong(ft.s3+last_partial_sums[NB_LSIZE_1+NB_LSIZE_P].s3)));
        }
    }
#endif
